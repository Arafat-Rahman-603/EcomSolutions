...
export default function AboutSection({ onOpenApplication }: AboutSectionProps) {
  return (
    <section id="about" className="relative py-24 lg:py-32 bg-[#0B0D0F] overflow-hidden">
      ...
      <div className="absolute top-1/3 -left-40 w-[600px] h-[600px] bg-[#A79CC8]/06 rounded-full blur-[180px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {/* Left Column: Narrative */}
          <div className="lg:col-span-6 space-y-7">
            <div className="inline-flex items-center gap-2.5 px-3.5 py-1 rounded-full bg-white/[0.04] border border-white/[0.08]">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-[#141619] border border-white/5">
                <ShieldCheck className="w-5 h-5 text-[#D7A6B8] mb-2" />
              ...
              <div className="p-4 rounded-2xl bg-[#141619] border border-white/5">
                <Globe2 className="w-5 h-5 text-[#A79CC8] mb-2" />
            ...
            <div className="pt-2">
              ...
              >
                ...
                <Sparkles className="w-4 h-4 text-[#A79CC8]" />
              </MagneticButton>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-3xl bg-[#14161A] border border-white/[0.12] p-7 sm:p-9 shadow-[0_20px_60px_rgba(0,0,0,0.7)] backdrop-blur-2xl overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-[#D7A6B8]/15 via-[#A79CC8]/10 to-transparent rounded-full blur-3xl pointer-events-none" />

              {/* Head office indicator */}
              <div className="flex items-center justify-between pb-6 border-b border-white/[0.08] mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-[#D7A6B8]">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-[#6E7078] block flex items-center gap-1 mt-0.5">
                      <MapPin className="w-3 h-3 text-[#A79CC8]" />
              ...
              <div className="space-y-3.5 mb-6">
                {[
                  { title: 'Store Management Engineers', count: '140+ Specialists', icon: Cpu, col: '#D7A6B8' },
                  { title: 'Product Sourcing Specialists', count: '85+ Researchers', icon: TrendingUp, col: '#A79CC8' },
                  { title: 'Customer Experience & Compliance', count: '75+ Full-Time Staff', icon: ShieldCheck, col: '#7F89C5' },
                ].map((dept, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-xs font-mono font-semibold text-[#A79CC8] bg-white/[0.04] px-2.5 py-1 rounded-lg">
                        {dept.count}
                      </span>
                    </div>
                  );
              ...
              <div className="p-4 rounded-2xl bg-[#181A1F] border border-white/[0.08] flex items-center justify-between">
                <div className="flex items-center gap-2.5 text-xs text-[#96989F]">
                  <Lock className="w-4 h-4 text-[#D7A6B8]" />
